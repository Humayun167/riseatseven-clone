...
const newsItems = [
  {
    id: 1,
    category: "Insights",
    image: assets.whatsNew1,
    author: { name: "Carrie Rose", avatar: assets.work1 },
    time: "2 mins",
  ...
  },
  {
    id: 2,
    category: "Strategy",
    image: assets.whatsNew2,
    author: { name: "Stephen Kenwright", avatar: assets.work2 },
    time: "4 days",
  ...
  },
  {
    ...
    image: assets.whatsNew3,
    author: { name: "John Doe", avatar: assets.work3 },
    time: "1 week",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
            ...
            <h2 className="text-[50px] lg:text-[75px] font-medium tracking-tight leading-none flex items-center">
              ...
              <span className="inline-flex items-center">
                <span className="inline-block w-12 h-12 md:w-16 md:h-16 lg:w-18 lg:h-18 rounded-lg overflow-hidden mx-3">
                  <img src={assets.whatsNewHeader} alt="" className="w-full h-full object-cover" />
                </span>
                New
              </span>
            </h2>
          ...
          <div className="hidden md:flex w-full md:w-[1/3] items-center justify-end">
            <PrimaryButton label="Explore more thoughts" url="/news" />
          </div>
        </div>
