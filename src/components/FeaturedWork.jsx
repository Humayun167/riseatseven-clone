...
const workImages = [assets.work1, assets.work2, assets.work3, assets.work4, assets.work5, assets.work6, assets.work7];

const works = [
  { id: 1, name: "SIXT", title: "An extra 3m clicks regionally through SEO", image: workImages[0], badge: "Car Rental", timeline: "2023-2025", bg: "bg-teal-400" },
  { id: 2, name: "Dojo - B2B", title: "A B2B success story for Dojo card machines", image: workImages[1], badge: "Card Machines", timeline: "2021-2025", bg: "bg-purple-400" },
  { id: 3, name: "Magnet Trade - B2B", title: "A full service SEO success story 170%+ increase", image: workImages[2], badge: "SEO", timeline: "2025-2026", bg: "bg-orange-400" },
  { id: 4, name: "Financial Services", title: "B2B Marketing", image: workImages[3], badge: "Finance", timeline: "2022-2023", bg: "bg-pink-400" },
  { id: 5, name: "Global Fashion Brand", title: "SEO & Digital PR", image: workImages[4], badge: "Fashion", timeline: "2024-2025", bg: "bg-blue-400" },
  { id: 6, name: "Tech Startup Scale-up", title: "Content & Growth Strategy", image: workImages[5], badge: "Technology", timeline: "2023-2024", bg: "bg-teal-400" },
  { id: 7, name: "Travel & Hospitality", title: "Digital PR Campaign", image: workImages[6], badge: "Travel", timeline: "2025-2026", bg: "bg-orange-400" },
  { id: 8, name: "Financial Services", title: "B2B Marketing", image: workImages[0], badge: "Finance", timeline: "2022-2023", bg: "bg-pink-400" },
  { id: 9, name: "Global Fashion Brand", title: "SEO & Digital PR", image: workImages[1], badge: "Fashion", timeline: "2024-2025", bg: "bg-blue-400" },
  { id: 10, name: "Tech Startup Scale-up", title: "Content & Growth Strategy", image: workImages[2], badge: "Technology", timeline: "2023-2024", bg: "bg-teal-400" },
  { id: 11, name: "Travel & Hospitality", title: "An extra 3m clicks regionally through SEO", image: workImages[3], badge: "Travel", timeline: "2025-2026", bg: "bg-orange-400" },
  { id: 12, name: "Financial Services", title: "A B2B success story for Dojo card machines", image: workImages[4], badge: "Finance", timeline: "2022-2023", bg: "bg-pink-400" },
];
